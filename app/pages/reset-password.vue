      ...
      <v-col cols="12" lg="7" class="auth-brand-col">
        <section class="brand-panel">
          ...
          <p class="brand-subtitle">
            Choose a new password to restore access to your NetCode account and continue
            your learning activities safely.
          </p>
          ...
          <div class="feature-grid">
            <article class="feature-card feature-blue">
              ...
              <div class="feature-text">
                Update your account credentials using the secure recovery session.
              </div>
            </article>

            <article class="feature-card feature-green">
              <div class="feature-icon feature-green-icon">
                <v-icon size="26">mdi-shield-check-outline</v-icon>
              </div>
              <div class="feature-title">Secure Update</div>
              <div class="feature-text">
                Your password update is processed through authenticated account recovery.
              </div>
            </article>

            <article class="feature-card feature-pink">
              <div class="feature-icon feature-pink-icon">
                <v-icon size="26">mdi-account-lock-open-outline</v-icon>
              </div>
              <div class="feature-title">Regain Access</div>
              <div class="feature-text">
                Get back into your dashboard and continue your classes and lab activities.
              </div>
            </article>
          </div>
        </section>
        ...
        <v-card class="auth-card" rounded="xl" elevation="0">
          ...
          <div class="auth-content pa-5 pa-sm-6 pa-md-8">
            ...
            <div class="text-body-1 text-grey-lighten-1 mb-6 auth-subheading">
              Enter your new password to restore access to your NetCode account.
            </div>
